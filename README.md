...
Try it without your own photos using the bundled sample images in
[`samples/`](samples/).
...
[MIT](LICENSE) © Posterly contributors. The MIT license covers the code; sample
images in `samples/` are demo content only.
